# Windows と Visual Studio と .NET のサポート状況について (2023.08)
...
# Windows と Visual Studio と .NET の各バージョンのサポート終了予定日

サポートが有効なバージョンは Windows 10-11, Visual Studio 2013-2022, NET Framework 3.5, 4.6.2, 4.7, 4.8, 6.0, 7.0 です。
|ソフトウェア名|リリース日|メインストリーム<br>サポートの終了日|延長サポート<br>の終了日|
|---|---|---|---|
|[Windows 11](https://learn.microsoft.com/ja-jp/windows/release-health/windows11-release-information)|2021年11月4日|未定|[未定](https://learn.microsoft.com/ja-jp/lifecycle/products/windows-11-home-and-pro)|
...
|[.NET 7.0](https://dotnet.microsoft.com/ja-jp/download/dotnet/7.0)|2022年11月8日|-|[2024年5月14日](https://dotnet.microsoft.com/ja-jp/platform/support/policy/dotnet-core)|
|[.NET 6.0 (LTS)](https://dotnet.microsoft.com/ja-jp/download/dotnet/6.0)|2021年11月9日|-|[2024年11月12日](https://dotnet.microsoft.com/ja-jp/platform/support/policy/dotnet-core)|
|[.NET Core 3.1 (LTS)](https://dotnet.microsoft.com/ja-jp/download/dotnet/3.1)|2019年12月3日|-|[2022年12月13日](https://dotnet.microsoft.com/ja-jp/platform/support/policy/dotnet-core)|
|[.NET Core 2.1 (LTS)](https://dotnet.microsoft.com/ja-jp/download/dotnet/2.1)|2018年5月30日|-|[2021年8月21日](https://dotnet.microsoft.com/ja-jp/platform/support/policy/dotnet-core)|
|[.NET Framework 4.8.1](https://dotnet.microsoft.com/ja-jp/download/dotnet-framework/net481)|2022年8月9日|-|[未定](https://learn.microsoft.com/ja-jp/lifecycle/products/microsoft-net-framework)|
|[.NET Framework 4.8](https://dotnet.microsoft.com/ja-jp/download/dotnet-framework/net48)|2019年4月18日|-|[未定](https://learn.microsoft.com/ja-jp/lifecycle/products/microsoft-net-framework)|
|[.NET Framework 4.7.2](https://dotnet.microsoft.com/ja-jp/download/dotnet-framework/net472)|2018年4月30日|-|[未定](https://learn.microsoft.com/ja-jp/lifecycle/products/microsoft-net-framework)|
|[.NET Framework 4.7.1](https://dotnet.microsoft.com/ja-jp/download/dotnet-framework/net471)|2017年10月17日|-|[未定](https://learn.microsoft.com/ja-jp/lifecycle/products/microsoft-net-framework)|
|[.NET Framework 4.7](https://dotnet.microsoft.com/ja-jp/download/dotnet-framework/net47)|2017年4月11日|-|[未定](https://learn.microsoft.com/ja-jp/lifecycle/products/microsoft-net-framework)|
...
|[.NET Framework 3.5<br> Service Pack 1](https://dotnet.microsoft.com/ja-jp/download/dotnet-framework/net35-sp1)|2007年11月19日|-|[2029年1月9日](https://learn.microsoft.com/ja-jp/lifecycle/products/microsoft-net-framework)|
...
+ Windows Vista：ユーザーアカウント制御（UAC）が導入された最初の Windows
...
# Visual Studio 開発環境がサポートする Windows バージョン

Visual Studio のプログラミング開発環境がサポートする Windows バージョンを以下に示します。

Yes は発売パッケージに明記されているバージョン、カッコ付きの Y はその後にリリースされマイクロソフトのホームページに記載されているバージョン、カッコ付きの U はユーザーコミュニティがインストール方法を見つけたバージョン、を表します。

|ソフトウェア名|11|10|8.1|7|Vista|XP|2000|98|
|---|---|---|---|---|---|---|---|---|
|[Visual Studio 2022 バージョン 17.7](https://learn.microsoft.com/ja-jp/visualstudio/releases/2022/release-notes)|Yes|Yes|-|-|-|-|-|-|
...
|[Visual Studio 6.0 SP6](https://www.microsoft.com/ja-jp/download/details.aspx?id=50722)|[(U)](http://nuke.vbcorner.net/Articles/VB60/VisualStudio6Installer/tabid/93/language/en-US/Default.aspx)|[(U)](https://lil.la/archives/3651)|[(U)](http://nuke.vbcorner.net/Articles/VB60/VisualStudio6Installer/tabid/93/language/en-US/Default.aspx)|[(U)](https://stackoverflow.com/questions/2501061/does-the-vb6-ide-run-on-windows-7-8-10-64-bit)|(Y)|(Y)|(Y)|Yes|

# C++, VB6, .NET の実行環境がサポートする Windows バージョン

Visual Studio で作成したプログラムを動かすためのランタイムライブラリがサポートする Windows バージョンを以下に示します。

Ins は OS に同梱されているバージョン、Opt は Windows の機能としてインストール可能なバージョン、Yes はマイクロソフトのホームページに「対応しているシステム」と記載されているバージョンを表します。
...
|[Visual Studio 6.0 ランタイム](https://learn.microsoft.com/ja-jp/previous-versions/visualstudio/visual-basic-6/visual-basic-6-support-policy)|Ins|Ins|Ins|Ins|Ins|Ins|Ins|
